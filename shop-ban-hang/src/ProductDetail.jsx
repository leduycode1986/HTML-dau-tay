    ...
    <Container className="py-5">
      <div className="detail-container shadow-sm">
        ...
        <div className="detail-info-box">
          ...
          <div className="mb-4 lh-lg text-secondary" dangerouslySetInnerHTML={{ __html: sp.moTa }}></div>
          <Button variant="success" size="lg" className="w-100 py-3 fw-bold shadow" onClick={() => themVaoGio(sp)}>MUA NGAY</Button>
        </div>
      </div>
    </Container>
  );
