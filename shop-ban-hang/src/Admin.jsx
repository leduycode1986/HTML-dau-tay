...
// 👇 QUAN TRỌNG: Import kiểu này sẽ không bao giờ thiếu Row, Col, Button...
...
function Admin({ dsSanPham, handleUpdateDS_SP, dsDanhMuc, handleUpdateDS_DM, dsDonHang, handleUpdateStatusOrder, handleDeleteOrder }) {
  ...
  const handleImageUpload = (e) => { 
      ...
      if (file) { const reader = new FileReader(); reader.onloadend = () => setFormDataSP({ ...formDataSP, anh: reader.result }); reader.readAsDataURL(file); } 
  };
  ...
  const handleMoveCategory = (item, dir) => { /* Logic sắp xếp giữ nguyên */ };

  // --- GIAO DIỆN ---
  if (!isLoggedIn) return (
      <Container className="vh-100 d-flex justify-content-center align-items-center" style={{background: '#e8f5e9'}}>
    ...
    <Container fluid className="p-4 bg-white min-vh-100">
      ...
      <Modal show={showModalSP} onHide={()=>setShowModalSP(false)} size="lg">
         ...
         <Modal.Body><Form>
            ...
            {/* ĐÂY LÀ CHỖ GÂY LỖI ROW LÚC TRƯỚC - GIỜ ĐÃ SỬA */}
