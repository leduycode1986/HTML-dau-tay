            ...
            <div className="bg-white p-4 border rounded shadow-sm">
              <Row>
                ...
                <Col md={6} className="border-end">
                  ...
                  <Row className="g-3">
                    {/* Cột thông tin tài khoản (chiếm 8 phần) */}
                    <Col md={8}>
                    ...
                    {/* Cột ảnh QR (chiếm 4 phần) */}
                    <Col md={4} className="text-center">
                        <div className="border rounded p-1 mb-2 bg-light">
                            {/* Giới hạn chiều cao max để không vỡ khung */}
                ...
                <Col md={6}>
                  ...
                  <Row className="g-3 mb-4">
                    ...
                    <Col md={12}>
                        ...
                        <InputGroup size="sm">
                            <Form.Control value={shopConfig.linkGuide} placeholder="/huong-dan" onChange={e=>setShopConfig({...shopConfig, linkGuide:e.target.value})}/><Button variant="outline-primary" onClick={() => openPostEditor('guide')}><i className="fa-solid fa-pen"></i> Soạn bài</Button>
                        </InputGroup>
                    </Col>
                  </Row>
