...
import { toSlug } from './App'; // Import toSlug để tạo link đẹp
    ...
    <div style={{background: '#f8f9fa', minHeight:'100vh'}}>
      ...
      <Container fluid className="p-3">
        <Tabs defaultActiveKey="config" className="bg-white p-2 rounded border shadow-sm mb-3">
              ...
              <Row>
                ...
                <Col md={8}>
                  <Row className="g-3">
                    ...
                    <Col md={12}><Form.Group><Form.Label className="fw-bold">Ảnh QR</Form.Label><div className="d-flex gap-2"><div style={{width:50,height:50,border:'1px solid #ddd'}}><img src={shopConfig.bankInfo?.qrImage} style={{width:'100%',height:'100%'}}/></div><Form.Control type="file" size="sm" onChange={e=>handleUpload(e,'QR')}/></div></Form.Group></Col>
          ...
          {/* CÁC TAB KHÁC GIỮ NGUYÊN (Danh mục, Đơn hàng, Banner...) */}
          ...
          {/* ... (Giữ nguyên Banner, Coupon, User) ... */}
        </Tabs>
      </Container>

      {/* MODAL SP (Dùng onSaveSP) */}
