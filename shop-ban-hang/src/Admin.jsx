    ...
    <div className="admin-main-container">
      ...
      <Container fluid className="p-3">
        <Tabs defaultActiveKey="config" className="bg-white p-2 rounded border shadow-sm mb-3">
          ...
          {/* CÁC TAB KHÁC GIỮ NGUYÊN HOẶC COPY TỪ BÀI TRƯỚC VÀO ĐÂY NẾU CẦN - ĐỂ TIẾT KIỆM CHỖ TÔI CHỈ GHI CHÚ */}
      ...
      <Modal show={modal.sp} onHide={()=>setModal({...modal,sp:false})} size="lg" centered>
        ...
        <Modal.Footer><Button variant="secondary" onClick={()=>setModal({...modal,sp:false})}>Hủy</Button><Button onClick={()=>handleUpdateDS_SP(editData.sp?'UPDATE':'ADD', formDataSP)}>Lưu</Button></Modal.Footer>
      </Modal>
      {/* MODAL DM */}
