...
function App() {
  ...
  const [shopConfig, setShopConfig] = useState({ tenShop: 'MaiVang Shop', slogan: '', logo: '' });
        ...
        <Navbar bg="white" variant="light" expand="lg" className="sticky-top shadow-sm py-2 border-bottom">
          <Container>
            <Navbar.Brand as={Link} to="/" className="d-flex align-items-center">
              {shopConfig.logo ? <img src={shopConfig.logo} alt="Logo" height="55" className="me-2" style={{objectFit:'contain'}} /> : <span className="fs-1 me-2">🦁</span>}
